...
<body>
    ...
    <div id="presentation">
        ...
        <p>C'est un site, sur lequel vous vous trouvez, <em>eh oui !!!!</em> , est un site dédié au tchat en ligne !<br>Bonne humeur et rigolade au rendez-vous !</p>
    </div>
    <div id="discuter">
        <div id="discGauche">
            <h2>Faites des rencontres !</h2>
            <p>Ici faites des rencontres en explorant les salons !<br>Ou bien rejoingez vos amis pour discuter avec eux !</p>
        </div>
        <div id="discDroite">
    ...
    <div id="petitmessage">
        <p>Amusez vous bien ==> <img src="../Labo_Dev_Web/assets/images/smile.png"></p>
